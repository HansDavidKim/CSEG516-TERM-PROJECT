#!/bin/bash
# Hardcoded evaluation script for FaceScrub dataset
...
echo "Dataset: FaceScrub"
echo "=========================================="
echo ""

# Hardcoded paths (verified to exist)
GENERATOR_PATH="checkpoints/generator/generator_facescrub_epochs_200_critic_steps_4.pt"
TARGET_CLASSIFIER="checkpoints/resnet152_facescrub_best.pt"
EVAL_CLASSIFIER="checkpoints/facenet_facescrub_best.pt"  # Using FaceNet as evaluation network
PRIVATE_DATA="dataset/private/facescrub-full"
